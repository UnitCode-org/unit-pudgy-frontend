...
export default function Tokenisation() {
  return (
    <div className='min-h-screen font-poppins'>
      <div className='h-[calc(100vh+2rem)] tokenisation-background-image px-6 md:px-16 fade-to-black'>
        <div className='max-w-7xl h-screen mx-auto w-full flex flex-col items-center justify-between'>
          ...
          <div className='flex items-center flex-col justify-center text-white max-w-xl text-center'>
            <FadeIn>
              <h2 className='md:text-2xl font-medium'>UNIT NETWORK X PUDGY</h2>
            </FadeIn>
            <FadeIn delay={0.5}>
              <h1 className='text-5xl md:text-8xl font-abhaya-libre font-semibold mt-2'>TOKENISATION</h1>
            </FadeIn>
          </div>
      ...
      <div className='w-full bg-white rounded-3xl -mt-[2rem]'>
        <div className='grid grid-cols-1 md:grid-cols-2 w-full max-w-7xl mx-auto pt-20 md:pt-32 gap-6 px-6 md:px-16'>
          <FadeIn enableInView delay={0.3}>
            <h1 className='text-4xl md:text-6xl md:text-[58px] font-abhaya-libre font-semibold'>
              WHAT IS UNITPUDGY TOKENISATION?
            </h1>
          </FadeIn>
          <FadeIn enableInView delay={0.6}>
            <p className='md:text-2xl md:text-[22px]'>
              Pudgy is being <span className='font-semibold'>tokenised</span> on the Unit Network, so many people can
              hold a Pudgy Penguin. We hope this will bring this movement to the world.
            </p>
          </FadeIn>
        </div>
        <div className='w-full max-w-7xl mx-auto px-6 md:px-16 py-14 md:py-20'>
          <hr className='border-[#DEDEDE] border w-full' />
        </div>
        <div className='grid grid-cols-1 md:grid-cols-2 w-full max-w-7xl mx-auto pt-0 md:pt-32 gap-6 px-6 md:px-16'>
          <FadeIn enableInView delay={0.6} className='order-last md:order-first'>
            <p className='md:text-2xl md:text-[22px]'>
              So we&apos;ll be buying up Pudgy&apos;s at the floor price, then allow many people to fractionally own it.
            </p>
          </FadeIn>
          <FadeIn enableInView delay={0.3}>
            <h1 className='text-4xl md:text-6xl md:text-[58px] font-abhaya-libre font-semibold'>HOW DOES IT WORK?</h1>
          </FadeIn>
        </div>
        <div className='w-full max-w-7xl mx-auto px-6 md:px-16 py-14 md:py-20'>
          <hr className='border-[#DEDEDE] border w-full' />
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 w-full max-w-7xl mx-auto pt-0 md:pt-32 gap-6 px-6 md:px-16'>
          <FadeIn enableInView delay={0.3}>
            <h1 className='text-4xl md:text-6xl md:text-[58px] font-abhaya-libre font-semibold'>
              WHICH TECHNOLOGY WILL THIS USE?
            </h1>
          </FadeIn>
          <FadeIn enableInView delay={0.6}>
            <p className='md:text-2xl md:text-[22px]'>
